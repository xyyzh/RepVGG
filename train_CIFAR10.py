...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 10 22:51:48 2021
...
def main():
    ...
    if args.multiprocessing_distributed:
        ...
        print("start to call main_worker")
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    lr_scheduler = CosineAnnealingLR(optimizer=optimizer, T_max=args.epochs * CIFAR10_TRAINSET_SIZE // args.batch_size // ngpus_per_node)
    ...
    val_loader = torch.utils.data.DataLoader(validation_dataset, batch_size=100, shuffle=True, num_workers=2)
